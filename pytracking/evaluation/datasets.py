...
dataset_dict = dict(
    ...
    uav20l=DatasetInfo(module=pt % "uav", class_name="UAVDataset", kwargs=dict(split='uav20l')),
    uav10fps=DatasetInfo(module=pt % "uav", class_name="UAVDataset", kwargs=dict(split='uav10fps')),
