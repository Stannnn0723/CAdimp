...
def run_experiment(experiment_module: str, experiment_name: str, debug=0, threads=0, gpu_ids=None):
    """Run experiment.
    args:
        ...
        gpu_ids: Optional GPU id list/string for multi-GPU inference, e.g. [0,1] or '0,1'.
    """
    ...
    run_dataset(dataset, trackers, debug, threads, gpu_ids=gpu_ids)
...
def main():
    ...
    run_experiment(args.experiment_module, args.experiment_name, args.debug, args.threads, args.gpu_ids)
